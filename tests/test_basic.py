...
def test_with_numbs():
    ...
    assert phonemes == ['w', 'a', 'q', 'a', 'd', '_+_', 'H', 'a', 'D', 'a', 'r', 'a', '_+_', 'l', '_dbl_', 'i', 'q', 'aa', '<', 'u', '_+_', '^', 'a', 'l', 'aa', '^', '_+_', '<', 'aa', 'l', '<', 'a', 'f', '_+_', 'u', '_dbl_', '_+_', 's', 'a', 'b', 'E', 'm', 'i', '<', 'a', '_+_', 'u', '_dbl_', '_+_', '<', 'a', 'r', 'b', 'a', 'E', '_+_', 'u', '_dbl_', '_+_', '^', 'a', 'l', 'aa', '^', 'u', '_dbl_', 'n', 'a', '_+_', 'f', 'a', 'r', 'd', 'a', 'n', '.']
